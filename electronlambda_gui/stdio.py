...
from electronlambda.util import format_satoshis, set_verbosity
from electronlambda.address import Address
from electronlambda.bitcoin import COIN, TYPE_ADDRESS
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electron-lambda create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'electron-lambda setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electron-lambda setconfig' to change your settings")
        return True
