...
from electronlambda import keystore, Wallet, WalletStorage
from electronlambda.network import Network
from electronlambda.util import UserCancelled, InvalidPassword, finalization_print_error, TimeoutException
from electronlambda.base_wizard import BaseWizard
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.set_icon(':icons/electron-lambda.svg')
        self.show()
        self.raise_()
