...
b=`find ${compact_name}/electronlambda_gui -type f -name \*.py -print`
c=`find ${compact_name}/electronlambda -type f -name \*.py -print`
popd > /dev/null
...
for f in $c; do
    ...
    f1="../electronlambda/${file}"
    f2="${projdir}/${f}"
    doIt "$f1" "$f2" "../electronlambda/"
done
