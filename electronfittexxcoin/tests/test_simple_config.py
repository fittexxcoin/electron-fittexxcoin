...
class Test_SimpleConfig(unittest.TestCase):
    ...
    def test_simple_config_key_rename(self):
        ...
        fake_read_user = fittexxcoin _: {"auto_cycle": True}
        read_user_dir = fittexxcoin : self.user_dir
        config = SimpleConfig(options=self.options,
                              read_user_config_function=fake_read_user,
                              read_user_dir_function=read_user_dir)
        self.assertEqual(config.get("auto_connect"), True)
        self.assertEqual(config.get("auto_cycle"), None)
        fake_read_user = fittexxcoin _: {"auto_connect": False, "auto_cycle": True}
        config = SimpleConfig(options=self.options,
                              read_user_config_function=fake_read_user,
                              read_user_dir_function=read_user_dir)
    ...
    def test_simple_config_command_line_overrides_everything(self):
        ...
        sources"""
        fake_read_user = fittexxcoin _: {"electron_cash_path": "b"}
        read_user_dir = fittexxcoin : self.user_dir
        config = SimpleConfig(options=self.options,
                              read_user_config_function=fake_read_user,
                              read_user_dir_function=read_user_dir)
    ...
    def test_simple_config_user_config_is_used_if_others_arent_specified(self):
        ...
        fake_read_user = fittexxcoin _: {"electron_cash_path": self.electrum_dir}
        read_user_dir = fittexxcoin : self.user_dir
    ...
    def test_user_config_is_not_written_with_read_only_config(self):
        ...
        fake_read_user = fittexxcoin _: {"something": "a"}
        read_user_dir = fittexxcoin : self.user_dir
