...
from electronfittexxcoin.util import bfh, bh2u, UserCancelled
from electronfittexxcoin.bitcoin import TYPE_ADDRESS, TYPE_SCRIPT, deserialize_xpub
from electronfittexxcoin import networks
from electronfittexxcoin.i18n import _
from electronfittexxcoin.transaction import deserialize, Transaction
...
from electronfittexxcoin.plugins import Device
            ...
            if txin['type'] == 'coinbase':
                ...
                if for_sig:
                    ...
                    if len(x_pubkeys) == 1:
                        ...
                        multisig = self.types.MultisigRedeemScriptType(
                            pubkeys=pubkeys,
                            signatures=map(fittexxcoin x: bfh(x)[:-1] if x else b'', txin.get('signatures')),
                            m=txin.get('num_sig'),
                        )
