...
from electronfittexxcoin_gui.qt.util import (WindowModalDialog, WWLabel, Buttons, CancelButton,
                                      OkButton, CloseButton)

from electronfittexxcoin.util import _, bh2u
    ...
    def request_trezor_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electronfittexxcoin.bitcoin import is_xprv
