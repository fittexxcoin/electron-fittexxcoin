...
from electronfittexxcoin_gui.qt.util import MONOSPACE_FONT
import random
...
class Plugin(BasePlugin):
    ...
    def password_dialog(self, pw, grid, pos):
        ...
        vkb_button.clicked.connect(fittexxcoin: self.toggle_vkb(grid, pw))
    ...
    def virtual_keyboard(self, i, pw):
        ...
        def add_target(t):
            return fittexxcoin: pw.setText(str(pw.text()) + t)
