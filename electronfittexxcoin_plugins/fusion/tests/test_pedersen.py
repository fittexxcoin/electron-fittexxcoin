...
if False:
    ...
    imp.load_module('electronfittexxcoin', *imp.find_module('lib'))
    imp.load_module('electronfittexxcoin_gui', *imp.find_module('gui/qt'))
    imp.load_module('electronfittexxcoin_plugins', *imp.find_module('plugins'))
