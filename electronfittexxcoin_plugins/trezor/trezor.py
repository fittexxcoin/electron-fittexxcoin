...
from electronfittexxcoin.util import bfh, bh2u, versiontuple, UserCancelled
from electronfittexxcoin.bitcoin import (b58_address_to_hash160, xpub_from_pubkey, deserialize_xpub,
                                  TYPE_ADDRESS, TYPE_SCRIPT)
from electronfittexxcoin.i18n import _
from electronfittexxcoin.networks import NetworkConstants
from electronfittexxcoin.plugins import BasePlugin, Device
from electronfittexxcoin.transaction import deserialize
from electronfittexxcoin.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
from electronfittexxcoin.address import ScriptOutput
...
class TrezorKeyStore(Hardware_KeyStore):
    ...
    def needs_prevtx(self):
        # Trezor does need previous transactions for Fittexxcoin
        return True
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_tx(self, tx_hash):
        # for electron-fittexxcoin previous tx is never needed, since it uses
        # bip-143 signatures.
        return None
