...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electron-fittexxcoin create'")
            exit()
    ...
    def print_addresses(self):
        messages = map(fittexxcoin addr: "%30s    %30s       "%(addr, self.wallet.labels.get(addr,"")), self.wallet.get_addresses())
    ...
    def network_dialog(self):
        print("use 'electron-fittexxcoin setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electron-fittexxcoin setconfig' to change your settings")
        return True
