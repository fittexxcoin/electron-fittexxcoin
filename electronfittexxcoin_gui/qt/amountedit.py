...
from electronfittexxcoin.util import format_satoshis_plain, inv_base_units
...
class BTCSatsByteEdit(BTCAmountEdit):
    def __init__(self, parent=None):
        BTCAmountEdit.__init__(self, decimal_point = fittexxcoin: 2, is_int = False, parent = parent)
    def _base_unit(self):
        return 'sats' + '/B'
    def get_amount(self):
        try:
