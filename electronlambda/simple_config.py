...
class SimpleConfig(PrintError):
    ...
    def electrum_path(self):
        ...
        self.print_error("electron-lambda directory", path)
        return path
    ...
    def has_fee_estimates(self):
        ...
        # We disabled fee estimates for LMC.  They do more harm than good.
    ...
    def is_fee_estimates_update_required(self):
        ...
        """
        return False # For now we disable fee estimates altogether. This is LMC. 1.0 sats/B pretty much works.
        # /
        now = time.time()
...
def read_user_config(path):
    """Parse and store the user config settings in electron-lambda.conf into user_config[]."""
    if not path:
        return {}
