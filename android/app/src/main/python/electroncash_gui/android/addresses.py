...
FILTERS = {
    0:  # All
        fittexxcoin wallet, addr: True,
    1:  # Used
        fittexxcoin wallet, addr: (wallet.get_address_history(addr) and
                              not wallet.get_addr_balance(addr)[0]),
    2:  # Funded
        fittexxcoin wallet, addr: wallet.get_addr_balance(addr)[0],
    3:  # Unused
        fittexxcoin wallet, addr: not wallet.get_address_history(addr),
}
