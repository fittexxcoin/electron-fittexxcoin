...
if False:
    ...
    imp.load_module('electronlambda', *imp.find_module('lib'))
    imp.load_module('electronlambda_gui', *imp.find_module('gui/qt'))
    imp.load_module('electronlambda_plugins', *imp.find_module('plugins'))
