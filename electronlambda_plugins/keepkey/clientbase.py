...
from electronlambda.util import PrintError, UserCancelled
from electronlambda.keystore import bip39_normalize_passphrase
...
class KeepKeyClientBase(GuiMixin, PrintError):
    ...
    def has_usable_connection_with_device(self):
        try:
            res = self.ping("electron-lambda pinging device") # FIXME: Add some randomness
            assert res == "electron-lambda pinging device"
