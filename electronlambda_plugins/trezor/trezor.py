...
from electronlambda.util import bfh, bh2u, versiontuple, UserCancelled
from electronlambda.bitcoin import (b58_address_to_hash160, xpub_from_pubkey, deserialize_xpub,
                                  TYPE_ADDRESS, TYPE_SCRIPT)
from electronlambda.i18n import _
from electronlambda.networks import NetworkConstants
from electronlambda.plugins import BasePlugin, Device
from electronlambda.transaction import deserialize
from electronlambda.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
from electronlambda.address import ScriptOutput
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_tx(self, tx_hash):
        # for electron-lambda previous tx is never needed, since it uses
        # bip-143 signatures.
        return None
