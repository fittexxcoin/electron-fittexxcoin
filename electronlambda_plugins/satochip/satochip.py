...
from electronlambda.bitcoin import TYPE_ADDRESS, int_to_hex, var_int
from electronlambda.i18n import _
from electronlambda.plugins import BasePlugin, Device
from electronlambda.keystore import Hardware_KeyStore
from electronlambda.transaction import Transaction
from electronlambda.wallet import Standard_Wallet
from electronlambda.util import print_error, bfh, bh2u, versiontuple, PrintError, is_verbose
from electronlambda.bitcoin import hash_160, Hash
from electronlambda.bitcoin import serialize_xpub
from electronlambda_gui.qt.qrcodewidget import QRCodeWidget, QRDialog
        ...
        for i,txin in enumerate(tx.inputs()):
            ...
            for j, x_pubkey in enumerate(x_pubkeys):
                ...
                if x_pubkey in derivations:
                    ...
                    if not is_cashtoken:
                        (response, sw1, sw2, tx_hash, needs_2fa) = client.cc.card_parse_transaction(pre_tx, True) # use 'True' since LMC use BIP143 as in Segwit...
